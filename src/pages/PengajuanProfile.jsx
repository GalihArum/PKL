                        ...
                        <div className="bg-white rounded-xl flex flex-row items-center justify-start flex-grow gap-1 px-10">
                            ...
                            </div>
                            {
                                ...
                                <div className="flex flex-col gap-2 min-w-[250px]">
                                    <button className="border-2 bg-blue-600 text-white rounded-xl px-7 py-1">Diterima</button>
                                    <button className="border-2 bg-red-600 text-white rounded-xl px-7 py-1">Ditolak</button>
                                </div>
                                :
                                <button className="border-2 border-black rounded-xl px-7 py-1">Upload Surat Balasan</button>
