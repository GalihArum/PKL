                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <div className="bg-white rounded-xl w-full py-4 px-8 flex flex-col gap-1 h-full min-h-[500px]">
                            ...
                            <div>
                            <div>Nama</div>
                            <input className="border-2 w-4/6 border-slate-400 rounded-lg px-3 text-slate-400" value={profiles[currentProfile].nama}/>
                            </div>
                            <div>
                            <div>NPM</div>
                            <input className="border-2 w-4/6 border-slate-400 rounded-lg px-3 text-slate-400" value={profiles[currentProfile].npm}/>
                            </div>
                            <div>
                            <div>Jurusan</div>
                            <input className="border-2 w-4/6 border-slate-400 rounded-lg px-3 text-slate-400" value={profiles[currentProfile].jurusan}/>
                            </div>
                            <div>
                            <div>Jenis Kelamin</div>
                            <input className="border-2 w-4/6 border-slate-400 rounded-lg px-3 text-slate-400" value={profiles[currentProfile].jenisKelamin}/>
                            </div>
                            <div>
                            <div>Email</div>
                            <input className="border-2 w-4/6 border-slate-400 rounded-lg px-3 text-slate-400" value={profiles[currentProfile].email}/>
                            </div>
                            <div>
                            <div>No Telfon</div>
                            <input className="border-2 w-4/6 border-slate-400 rounded-lg px-3 text-slate-400" value={profiles[currentProfile].noTelp}/>
                            </div>
                            </div>
